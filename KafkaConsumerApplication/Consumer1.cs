namespace KafkaConsumerApplication
{
    ...
    public class Consumer1 : IHostedService, IDisposable //BackgroundService
    {
            ...
            if (!isBackgroundProcess)
            {
                ...
                try
                {
                    while (true)
                    {
                        ...
                        Console.WriteLine($"Consumer - 1 :: Message received from {consumeResult.TopicPartitionOffset}: {consumeResult.Message.Value}");
                    }
